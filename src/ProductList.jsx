...
const handlePlantsClick = (e) => {
  ...
  const handleAddToCart = (plant) => {
        dispatch(addItem(plant)); // Envoyer l'action au réducteur CartSlice
        setAddedToCart((prevState) => ({
            ...prevState,
            [plant.name]: true, // Marquer la plante comme ajoutée au panier
        }));
    };
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button 
                                            ...
                                            disabled={addedToCart[plant.name]} // Désactiver le bouton si déjà ajouté
                                        >
